...
INSERT INTO "new_User" ("bestRoundScore", "bestStreak", "cardsGuessed", "createdAt", "currentStreak", "email", "fastestGuess", "gamesPlayed", "gamesWon", "highScore", "id", "name", "picture", "profileCompleted", "provider", "rarityStats", "sharesCount", "socials", "timesBeatenHighScore", "totalAttempts", "totalDonated", "totalScore", "uniqueSetsGuessed", "updatedAt") SELECT "bestRoundScore", "bestStreak", "cardsGuessed", "createdAt", "currentStreak", "email", "fastestGuess", "gamesPlayed", "gamesWon", "highScore", "id", "name", "picture", "profileCompleted", "provider", "rarityStats", "sharesCount", "socials", "timesBeatenHighScore", "totalAttempts", "totalDonated", "totalScore", "uniqueSetsGuessed", "updatedAt" FROM "User";
DROP TABLE "User";
