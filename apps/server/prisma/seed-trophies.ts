...
const trophies = [
  ...
  // Rarity Trophies (3)
  {
    key: 'rare_hunter',
    name: 'Rare Hunter',
    description: 'Correctly guess 50 rare cards',
    category: 'rarity',
    tier: 'silver',
    icon: '💎',
    requirement: 50,
  },
  {
    ...
    description: 'Correctly guess 25 ultra rare cards',
    category: 'rarity',
    tier: 'gold',
    icon: '💎',
    requirement: 25,
  },
  {
    key: 'secret_seeker',
    name: 'Secret Seeker',
    description: 'Correctly guess 10 secret rare cards',
    category: 'rarity',
    tier: 'diamond',
    icon: '💎',
    requirement: 10,
  ...
  },
  {
    key: 'speedrunner',
    name: 'Speedrunner',
    description: 'Complete a 10-round game in under 3 minutes',
    category: 'speed',
    tier: 'gold',
    icon: '⚡',
    requirement: 180,
  ...
  {
    key: 'time_attack_master',
    name: 'Time Attack Master',
    description: 'Average under 5 seconds per guess over 20 games',
    category: 'speed',
    tier: 'diamond',
    icon: '⚡',
    requirement: 5,
